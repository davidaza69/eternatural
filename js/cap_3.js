...
btnAdd.addEventListener( "click", function(){
    ...
    if(count == 4){
        console.log('Habilitaste el cap 4')
        let cap4 = JSON.parse( localStorage.getItem('todosCapitulos') )
        cap4[3].habilitado = true
        localStorage.setItem( 'todosCapitulos', JSON.stringify(cap4) ) 
        console.log(cap4)
    }
